...
window.onload=function(){
	...
	_chkG.addEventListener("checked", () =>
	{
		_puntiG.textContent = 10 + parseInt(_puntiG.textContent);
	});
	let _chkB = _assoB.children[0]
	_chkB.addEventListener("checked", () =>
	{
		_puntiB.textContent = 10 + parseInt(_puntiG.textContent);
	});

    _btnG.addEventListener("click",() =>
		{
			let x = generaCarta(_cartaG,_assoG);
